...
public class ListUtilTest {
    ...
    @Test
    public void newList() {
        List<Object> objects = ListUtil.newList();
    ...
    public void testNewList() {
        List<Object> linkedList = ListUtil.newList(Boolean.TRUE);
        assert LinkedList.class.equals(linkedList.getClass());
        assert linkedList.size() == 0;

        List<Object> arrayList = ListUtil.newList(Boolean.FALSE);
    ...
    public void newArrayList() {
        List<Object> arrayList = ListUtil.newArrayList();
        assert ArrayList.class.equals(arrayList.getClass());
        assert arrayList.size() == 0;
    }
    ...
    public void newLinkedList() {
        List<Object> linkedList = ListUtil.newLinkedList();
        assert LinkedList.class.equals(linkedList.getClass());
        assert linkedList.size() == 0;
    }
    ...
    public void newArrayListByVarargs() {
        ...
        List<Object> arrayList = ListUtil.newArrayList(varargs);
        assert ArrayList.class.equals(arrayList.getClass());
    ...
    public void newArrayListByIterator() {
        String [] varargs = {"B","A","C","C"};
        Set<Object> sets = SetUtil.newHashSet(varargs);
        List<Object> arrayList = ListUtil.newArrayList(sets.iterator());
        assert ArrayList.class.equals(arrayList.getClass());
        assert arrayList.size() == 3;
    }
    ...
    public void newLinkedListByVarargs() {
        String [] varargs = {"B","A","C","C"};
        List<Object> linkedList = ListUtil.newLinkedList(varargs);
        assert LinkedList.class.equals(linkedList.getClass());
    ...
    public void newLinkedListByCollection() {
        String [] varargs = {"B","A","C","C"};
        Set<Object> sets = SetUtil.newHashSet(varargs);
        List<Object> linkedList = ListUtil.newLinkedList(sets);
        assert LinkedList.class.equals(linkedList.getClass());
    ...
    public void newLinkedListByIterator() {
        String [] varargs = {"B","A","C","C"};
        Set<Object> sets = SetUtil.newHashSet(varargs);
        List<Object> linkedList = ListUtil.newLinkedList(sets.iterator());
        assert LinkedList.class.equals(linkedList.getClass());
        assert linkedList.size() == 3;
    }
    ...
    public void newCopyOnWriteArrayList() {
        List<String> copyOnWriteArrayList = ListUtil.newCopyOnWriteArrayList(ListUtil.newArrayList("1", "2", "3"));
    ...
    @Test
    public void sort(){
        List<ComparatorUser> userList = ListUtil.newList();
        ...
        ListUtil.sort(userList, Comparator.comparingInt(ComparatorUser::getAge));
        for (int i = 0; i < userList.size(); i++) {
            log.debug(userList.get(i).toString());
            assert i != 0 || "A".equals(userList.get(i).getName());
            assert i != 1 || "AA".equals(userList.get(i).getName());
    ...
    public void sortByComparable(){
        List<ComparableUser> userList = ListUtil.newList();
