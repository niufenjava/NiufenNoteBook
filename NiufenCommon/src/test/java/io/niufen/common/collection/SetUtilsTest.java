...
public class SetUtilsTest {
    ...
    @Test
    public void newSet() {
        Set<Object> sets = SetUtils.newSet();
        assert null != sets;
    ...
    public void newHashSet() {
        Set<Object> sets = SetUtils.newHashSet();
        assert null != sets;
        assert HashSet.class.equals(sets.getClass());
        assert !Set.class.equals(sets.getClass());
        assert !LinkedHashSet.class.equals(sets.getClass());
    ...
    public void newLinkedHashSet() {
        Set<Object> sets = SetUtils.newLinkedHashSet();
        assert null != sets;
        assert LinkedHashSet.class.equals(sets.getClass());
        assert !Set.class.equals(sets.getClass());
        assert !HashSet.class.equals(sets.getClass());
    ...
    public void newHashSetByVarargs() {
        String[] varargs = {"A"};
        assert SetUtils.newHashSet(varargs).getClass().equals(HashSet.class);

        Set<Object> hashSet = SetUtils.newHashSet("B", "B", "C", "A");
    ...
    public void newHashSetByCollection() {
        ...
        Set<String> hashSet = SetUtils.newHashSet(list);
    ...
    public void newHashSetByIterator() {
        ...
        List<String> list = testList();
        Set<String> hashSet = SetUtils.newHashSet(list.iterator());
    ...
    public void newLinkedHashSetByVarargs() {
        ...
        assert SetUtils.newLinkedHashSet(elements).getClass().equals(LinkedHashSet.class);

        Set<Object> strLinkedHashSet = SetUtils.newLinkedHashSet("B", "B", "C", "A");
    ...
    public void newLinkedHashSetByCollection() {
        List<String> list = testList();
        Set<String> strLinkedHashSet = SetUtils.newLinkedHashSet(list);
    ...
    public void newLinkedHashSetByIterator() {
        List<String> list = testList();
        Set<String> strLinkedHashSet = SetUtils.newLinkedHashSet(list.iterator());
