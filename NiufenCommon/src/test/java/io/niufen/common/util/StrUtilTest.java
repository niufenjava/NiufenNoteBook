...
public class StrUtilTest {
    ...
    public void removeBlank(){
        assert "t_user".equals(StrUtil.removeBlank(" t_ u ser "));
        assert "".equals(StrUtil.removeBlank(" "));
        assert null == StrUtil.removeBlank(null);
    }
    ...
    public void upperFirstAndAddPrefix(){
        assert "setName".equals(StrUtil.upperFirstAndAddPrefix("name","set"));
        assert "getUserName".equals(StrUtil.upperFirstAndAddPrefix("userName","get"));
        assert "getSetN".equals(StrUtil.upperFirstAndAddPrefix("setN","get"));
        assert "Set".equals(StrUtil.upperFirstAndAddPrefix("set",""));
        assert null == StrUtil.upperFirstAndAddPrefix(null,"");
    }

    @Test
    public void removeSuffixAndLowerFirst(){
        assert "userName".equals(StrUtil.removeSuffixAndLowerFirst("UserNameDesc","Desc"));
        assert "userName".equals(StrUtil.removeSuffixAndLowerFirst("userNameA","A"));
        assert "set".equals(StrUtil.removeSuffixAndLowerFirst("Set",""));
        assert null == StrUtil.removeSuffixAndLowerFirst(null,"");
    }
