...
public class ArrayUtilTest {
    ...
    public void hasNull() {
        ...
        assert !ArrayUtil.notHasNull(array);
        assert ArrayUtil.notHasNull(notHasNull);
        assert ArrayUtil.notHasNull(nullArray);
        assert ArrayUtil.notHasNull(emptyArray);
    }

    @Test
    public void firstNotNull() {
        Integer[] array = {null, 2, 3, null};
        assert 2 == ArrayUtil.firstNotNull(array);

        Integer[] array2 = {null, null};
        assert null == ArrayUtil.firstNotNull(array2);
    }
    ...
    public void containsAny() {
        ...
        byte[] byteArray = {1, 2, 3, 1};
        assert !ArrayUtil.containsAny(byteArray, (byte) 0, (byte) 10);
        assert ArrayUtil.containsAny(byteArray, (byte) 1, (byte) 0);

        int[] intArray = {1, 2, 3, 1};
        assert !ArrayUtil.containsAny(intArray, 0, 5);
        assert ArrayUtil.containsAny(intArray, 1, 5);
    }
