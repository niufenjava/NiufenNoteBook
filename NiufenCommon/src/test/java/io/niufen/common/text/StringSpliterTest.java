...
public class StringSpliterTest {
    ...
    public void splitPath() {
        ...
        List<String> pathList = StringSpliter.splitPath(path);
    ...
    public void splitByChar() {
        ...
        String str = "a-b-c ";
        char separator = '-';
        List<String> splitList = StringSpliter.split(str, separator);
        ...
        // 根据给定的字符，切分字符串，限制分片
        splitList = StringSpliter.splitLimit(str, separator,2);
        ...
        str = "a-- b-c ";
        separator = '-';
        splitList = StringSpliter.splitTrim(str,separator);
        ...
        str = "a-- b-c ";
        separator = '-';
        splitList = StringSpliter.splitIgnoreEmpty(str,separator);
        assert 3 == splitList.size();
        assert "a".equals(splitList.get(0));
        assert " b".equals(splitList.get(1));
        assert "c ".equals(splitList.get(2));
        ...
        str = "a- - b-c ";
        separator = '-';
        splitList = StringSpliter.splitTrimAndIgnoreEmpty(str,separator);
        assert 3 == splitList.size();
        assert "a".equals(splitList.get(0));
        assert "b".equals(splitList.get(1));
        assert "c".equals(splitList.get(2));
        ...
        str = "1A2a3";
        separator = 'a';
        splitList = StringSpliter.splitIgnoreCase(str,separator);
        assert 3 == splitList.size();
    ...
    public void splitByString() {
        ...
        str = "a||b||c ";
        separator = "||";
        splitList = StringSpliter.split(str, separator);
        assert 3 == splitList.size();
        assert "a".equals(splitList.get(0));
        assert "b".equals(splitList.get(1));
        assert "c ".equals(splitList.get(2));
    ...
    public void splitWhitespace() {
        ...
        List<String> stringList = StringSpliter.splitByWhitespace(str);
        ...
        stringList = StringSpliter.splitByWhitespace(str,2);
