...
import io.niufen.common.core.io.LineHandler;
...
public class FileReader extends FileWrapper {
    ...
    private static final long serialVersionUID = -1199436634213469183L;
     ...
     * @return {@link FileReader}
     */
    public static FileReader create(String filepath) {
    ...
    public byte[] readBytes() throws IORuntimeException {
        ...
        if (len >= Integer.MAX_VALUE) {
            throw new IORuntimeException("File is larger than max array size!");
        }
