package io.niufen.common.core.date;

import io.niufen.common.core.comparator.CompareUtil;
import io.niufen.common.core.date.format.DateParser;
import io.niufen.common.core.date.format.DatePrinter;
import io.niufen.common.core.lang.Assert;
import io.niufen.common.core.lang.PatternPool;
...
public class DateUtil extends CalendarUtil {
	...
	public static int timeToSecond(String timeStr) {
		...
		final List<String> hms = StrUtil.splitTrim(timeStr, StrUtil.COLON, 3);
