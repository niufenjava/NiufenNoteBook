package io.niufen.common.core.comparator;

import io.niufen.common.core.text.StrSpliter;
import io.niufen.common.core.util.CharUtil;
...
public class VersionComparator implements Comparator<String>, Serializable {
	...
	public int compare(String version1, String version2) {
		...
		final List<String> v1s = StrSpliter.split(version1, CharUtil.DOT);
		final List<String> v2s = StrSpliter.split(version2, CharUtil.DOT);
