...
public class ArrayUtil {
    ...
    public static <T> T[] filter(T[] array, Editor<T> editor) {
        ArrayList<T> list = ListUtil.newList(array.length);
        T modified;
        for (T t : array) {
    ...
    public static <T> T[] filter(T[] array, Filter<T> filter) {
        ...
        final ArrayList<T> list = ListUtil.newList(array.length);
        for (T t : array) {
            if (filter.accept(t)) {
                list.add(t);
            }
    ...
    public static <T> T[] toArray(Iterator<T> iterator, Class<T> componentType) {
        return toArray(ListUtil.newArrayList(iterator), componentType);
    }
