...
public class DateUtil {
    ...
    public static String dateLastDayStr(String pattern, String date) {
        ...
        return simpleDateFormat.format(DateUtil.stringToDate(date).getTime() + ONE_DAYM_MSEC);
    }
    ...
    public static String nowStr() {
        return new SimpleDateFormat(PATTERN_D).format(DateUtil.getDate());
    }
    ...
    public static String nowStrB() {
        return new SimpleDateFormat(PATTERN_B).format(DateUtil.getDate());
    }
    ...
    public static String nowStrYmd() {
        return new SimpleDateFormat(PATTERN_A).format(DateUtil.getDate());
    }
    ...
    public static String nowStrEData() {
        return new SimpleDateFormat(PATTERN_E).format(DateUtil.getDate());
    }
