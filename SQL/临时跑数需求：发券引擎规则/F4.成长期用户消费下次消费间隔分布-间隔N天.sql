...
SELECT COUNT(*) FROM
  ...
  (
    ...
    WHERE
      o.STATUS = 50
      and datediff(dim.dt,"2018-01-31") = 2
  ...
  LEFT JOIN (
            ...
            ) mmm ON mmm.member_id = ttt.member_id
  -- 前几天
  LEFT JOIN
  (
    SELECT
    ...
    WHERE
      o.STATUS = 50
      and dim.dt > "2018-01-31"
      and datediff(dim.dt,"2018-01-31") = 1
      and m.member_id is not null
  ) aaa ON aaa.member_id = ttt.member_id
WHERE aaa.member_id is null
      and mmm.member_id is null
"""
