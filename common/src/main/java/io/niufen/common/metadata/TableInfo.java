package io.niufen.common.metadata;

import io.niufen.common.annotation.NoColumn;
import io.niufen.common.annotation.PrimaryKey;
...
import io.niufen.common.util.MapperUtils;
...
public class TableInfo {
    ...
    public static String tableName(Class<?> entityType) {
        ...
        return table == null ? TABLE_PREFIX + StringUtils.camel2Underscore(MapperUtils.removeEntityStr(entityType.getSimpleName())) : table.value();
    }
    ...
    public static String bindParameterByEntity(Field field) {
        return "#{" + SqlConstants.KEY_ENTITY+ StringConstants.DOT +field.getName() + "}";
    }
    /**
     * 绑定参数
     *
    ...
    public static String bindParameterByParams(Field field) {
        return "#{" + SqlConstants.KEY_MAP_PARAMS+ StringConstants.DOT +field.getName() + "}";
    }
    /**
     * 绑定参数
     *
    ...
    public static String bindParameterByCriteria(Field field) {
        return "#{" + SqlConstants.KEY_CRITERIA+ StringConstants.DOT +field.getName() + "}";
    }
